    ...
    function Window:AddTab(name)
        ...
        local function CreateElements(ContentObj)
            ...
            local function addColorPicker(holder, id, cfg)
                ...
                local BlackG = Library:Create("Frame", { Size = UDim2.new(1,0,1,0), ZIndex = 5003, Parent = Sat }); Library:Create("UIrGradient", { Rotation = 90, Color = ColorSequence.new(Color3.new(0,0,0)), Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1), NumberSequenceKeypoint.new(1,0)}), Parent = BlackG })
